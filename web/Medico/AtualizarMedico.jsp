            ...
            <form action="atualizarmedico" method="post">
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" class="form-control" id="inputnome" name="nomemedico" value="<%= request.getAttribute("nomemedico")%>">
                    </div>
                    <div class="form-group col-md-6">
                        <label for="inputemail">E-mail:</label>
                        <input type="email" class="form-control" id="inputemail" name="email" value="<%= request.getAttribute("email")%>">
                    </div>
                </div>
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" class="form-control" id="inputcelularwhatsapp" name="celularwhats" value="<%= request.getAttribute("celularwhats")%>" required  onkeyup="maskIt(this, event, '(##)#####-####')">
                    </div>
                    <div class="form-group col-md-6">
                        <label for="inputcelular">Celular</label>
                        <input type="text" class="form-control" id="inputcelular" name="celularmedico" value="<%= request.getAttribute("celularmedico")%>" onkeyup="maskIt(this, event, '(##)####-####')">
                    </div>
                ...
                <div class="form-row">
                    <div class="form-group col-md-4" style="size:30px">
                        ...
                        <input type="text" class="form-control" id="inputcnpj" name="crm" value="<%= request.getAttribute("crm")%>">
                    </div> 
                    <div class="form-group col-md-4">
                        <label for="inputcpf">CPF:</label>
                        <input type="text" class="form-control" id="inputcpf" name="cpfmedico" placeholder="Digite o CPF do médico" required onkeyup="maskIt(this, event, '###.###.###-##')" value="<%= request.getAttribute("cpfmedico")%>">
                    </div>
                    <div class="form-group col-md-4" style="size:30px">
                        <label for="inputcnpj">CNPJ:</label>
                        <input type="text" class="form-control" id="inputcnpj" name="cnpjmedico" placeholder="Digite o CNPJ do médico" onkeyup="maskIt(this, event, '##.###.###/####-##')" value="<%= request.getAttribute("cnpjmedico")%>">
                    </div>    
                    <%}
    }%>
                </div>
                ...
                <div class="form-row">
                    ...
                    <button type="submit" class="btn btn-primary" style=" float: left; margin-left: 1.5%">Atualizar Médico</button> 
