            ...
            <form action="atualizarmedico" method="post">
                ...
                <fieldset><legend>Dados do Medico</legend>
                    ...
                    <div style="width:61.5%">
                        ...
                        <div style="float:right"> Celuar: </div>
                    </div>
                    <br>
                    <div style="width:80%">

                        <div style="float:left"> <input type="text" name="celularwhats" onkeyup="maskIt(this, event, '(##)####-####')" value="<%= request.getAttribute("celmenmedico")%>" required size="31"></div>    
                        <div style="float:right"><input type="text" name="celularmedico" onkeyup="maskIt(this, event, '(##)####-####')" value="<%= request.getAttribute("foneresidencial")%>"size="31"></div>
                    </div>
                    <br><br>
                    e-mail: <br>
