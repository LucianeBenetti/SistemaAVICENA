...
public class DadosEmail {
    ...
    public DadosEmail(String smtpHostMail, String smtpPortMail, String smtpAuth, String smtpStarttls, String fromNameMail, String userMail, String passMail, String subjectMail, String bodyMail, Map<String, String> toMailsUsers, List<String> fileMails, String charsetMail, String typeTextMail) {
    ...
    public String toString() {
        return "DadosEmail{" + "smtpHostMail=" + smtpHostMail + ", smtpPortMail=" + smtpPortMail + ", smtpAuth=" + smtpAuth + ", smtpStarttls=" + smtpStarttls + ", fromNameMail=" + fromNameMail + ", userMail=" + userMail + ", passMail=" + passMail + ", subjectMail=" + subjectMail + ", bodyMail=" + bodyMail + ", toMailsUsers=" + toMailsUsers + ", fileMails=" + fileMails + ", charsetMail=" + charsetMail + ", typeTextMail=" + typeTextMail + '}';
    }
