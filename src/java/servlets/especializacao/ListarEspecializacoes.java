...
public class ListarEspecializacoes extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        ArrayList<EspecializacaoVO> especializacoesVO = especializacaoController.listarTodasAsEspecializacoesVO();
