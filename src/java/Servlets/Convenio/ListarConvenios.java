...
public class ListarConvenios extends HttpServlet {
 protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (conveniosVO != null) {
            ...
            request.getRequestDispatcher("Convenio/ListarTodosOsConvenios.jsp").forward(request, response);
            System.out.print(conveniosVO);
        }
    }
